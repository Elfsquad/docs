...
Webhooks allow you to build integrations which subscribe to certain in Elfskot. When one of those events is triggered, we'll send a HTTP POST payload to the webhook's configured `CallbackUrl`.
