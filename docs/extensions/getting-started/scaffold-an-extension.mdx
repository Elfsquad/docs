...
use the [Elfsquad CLI](https://github.com/elfsquad/cli)
to develop the extension.

## Requirements
* You've installed the [Elfsquad CLI](https://github.com/elfsquad/cli)

<hr />

## Create a new extension
You can create a new Elfsquad extension using the [Elfsquad CLI](https://github.com/elfsquad/cli). 
