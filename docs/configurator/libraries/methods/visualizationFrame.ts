export default [
  {
    ...
    "description": "Initializes a new instance of the third-party visualization.",
    "example": {
  ...
  {
    "methodName": "onUpdateLinkedConfigurationCardinality",
    "description": "Registers a callback function to be invoked when a linked configuration cardinality should be updated.",
    "example": {
      "content": "const updateLinkedConfigurationCardinality = (data) => {\n  // your update linked configuration cardinality logic here\n};\n\nconst visualization = new VisualizationFrame({ container: '#showroom', url: 'https://...' });\nvisualization.onUpdateLinkedConfigurationCardinality(data => {\n  updateLinkedConfigurationCardinality(data);\n});\n",
      "language": "typescript"
    },
    "parameters": [
      {
        "name": "callback",
        "type": "UpdateLinkedConfigurationCardinalityCallback",
        "description": "The callback function to be called when a linked configuration cardinality should be updated.",
        "required": true,
        "parameters": []
      }
    ],
  ...
  {
    "methodName": "onDragStarted",
    "description": "Registers a callback function to be invoked when a drag operation is started.",
    "example": {
      "content": "const dragStarted = (data) => {\n  // your drag started logic here\n};\n\nconst visualization = new VisualizationFrame({ container: '#showroom', url: 'https://...' });\nvisualization.onDragStarted(data => {\n  dragStarted(data);\n});\n",
      "language": "typescript"
    },
    "parameters": [
      {
        "name": "callback",
        "type": "DragStartedCallback",
        "description": "The callback function to be called when a drag operation is started.",
        "required": true,
        "parameters": []
      }
    ],
  ...
  {
    "methodName": "onRemoveLinkedConfiguration",
    "description": "Registers a callback function to be invoked when a linked configuration should be removed.",
    "example": {
      "content": "const removeLinkedConfiguration = (data) => {\n  // your remove linked configuration logic here\n};\n\nconst visualization = new VisualizationFrame({ container: '#showroom', url: 'https://...' });\nvisualization.onRemoveLinkedConfiguration(data => {\n  removeLinkedConfiguration(data);\n});\n",
      "language": "typescript"
    },
    "parameters": [
      {
        "name": "callback",
        "type": "RemoveLinkedConfigurationCallback",
        "description": "The callback function to be called when a linked configuration should be removed.",
        "required": true,
        "parameters": []
      }
    ],
